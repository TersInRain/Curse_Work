...
class ProductInfo(models.Model):
  ...
  sroke = models.DecimalField(decimal_places = 2, max_digits=12)
...
class Product(models.Model):
  ...
  sroke =models.DecimalField(max_digits=10, decimal_places = 4, verbose_name = 'Количество дней', default = 30)
  album = models.ForeignKey(Album, on_delete = models.CASCADE, verbose_name = 'Альбом')
